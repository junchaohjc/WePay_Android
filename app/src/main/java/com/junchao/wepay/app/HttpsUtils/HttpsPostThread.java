package com.junchao.wepay.app.HttpsUtils;
    ...
    public void run() {
        ...
        try {
           ...
           // post.setEntity(new UrlEncodedFormEntity(valueList, HTTP.UTF_8));
            ...
            post.setEntity(new StringEntity(valueList.toString(),HTTP.UTF_8));
